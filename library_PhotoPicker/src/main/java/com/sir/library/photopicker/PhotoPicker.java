...
public class PhotoPicker {
    ...
    public final static String EXTRA_PICTURES_FOLDER = "PICTURES_FOLDER";
    ...
    public static class PhotoPickerBuilder {
        ...
        public PhotoPickerBuilder setShowPicturesFolder(String pictures) {
            mPickerOptionsBundle.putString(EXTRA_PICTURES_FOLDER, pictures);
            return this;
        }
    }
}
