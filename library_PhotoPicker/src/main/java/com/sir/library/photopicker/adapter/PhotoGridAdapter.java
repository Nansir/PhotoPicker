package com.sir.library.photopicker.adapter;
...
public class PhotoGridAdapter extends SelectableAdapter<PhotoGridAdapter.PhotoViewHolder> {
    ...
    public PhotoViewHolder onCreateViewHolder(ViewGroup parent, int viewType) {
        final View itemView = LayoutInflater.from(parent.getContext()).inflate(R.layout.view_picker_item_photo, parent, false);
    ...
    public void onBindViewHolder(final PhotoViewHolder holder, int position) {
        ...
        if (getItemViewType(position) == ITEM_TYPE_PHOTO) {
            ...
            holder.ivPhoto.setImageResource(R.drawable.selector_picker_camera);
        }
    }
